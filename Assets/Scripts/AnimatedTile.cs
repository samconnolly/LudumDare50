...
namespace UnityEngine.Tilemaps
{
    ...
    public class AnimatedTile : TileBase
    {
        ...
        public override bool GetTileAnimationData(Vector3Int location, ITilemap tileMap, ref TileAnimationData tileAnimationData)
        {
            ...
            {
                Sprite[] m_AnimatedSpritesRandomised = new Sprite[m_AnimatedSprites.Length];
                List <Sprite> spriteList = new List<Sprite>{};
                foreach (Sprite sprite in m_AnimatedSprites)
                {
                ...
                for (int i=0; i<m_AnimatedSprites.Length; i++)
                {
                    ...
                    m_AnimatedSpritesRandomised[i] = sprite;
                    spriteList.Remove(sprite);
                }

                tileAnimationData.animatedSprites = m_AnimatedSpritesRandomised;
